...
class TestSend(unittest.TestCase):
    ...
    def test_generateMessage(self):
        gbnSend.generateMessages()
        #Correct number of messages generated
        self.assertEqual(len(gbnSend.messages), gbnSend.NUM_MESSAGES)

    def test_makePacket(self):
        #make sure packet is being generated correctly
        packet = gbnSend.makePacket(0,"hey",0)
    ...
    def test_validate(self):
        ...
        result = gbnSend.validate(packet)
